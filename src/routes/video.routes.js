...
import {publishVideo,removeVideo,getAllVideo,getAllDetailsOfVideo} from "../controllers/video.controllers.js"
const router = Router();
...
router.route("/getAllVideoDetails/:videoId").post(verifyJWT,getAllDetailsOfVideo)
